...
let hangmen = [
  ...
  require('../../images/Hangman-22.jpg'),
  require('../../images/Hangman-33.jpg'),
  require('../../images/Hangman-44.jpg'),
  require('../../images/Hangman-55.jpg'),
  require('../../images/Hangman-66.jpg'),
  require('../../images/Hangman-77.jpg'),
  require('../../images/Hangman-88.jpg'),
  require('../../images/Hangman-full.jpg')
]
...
class Hangman extends Component {
  ...
  _handleKeyDown = (event) => {
    ...
    this.readUserKeyInput(userGuess)
  }
  ...
  switchOutUnderscores = (userGuess) => {
    ...
    if (wordToGuess.indexOf(userGuess) == -1) {
      ...
      // This sets the state of the hangman pic
      let hangmanPercent = 9 - livesLeft;
      console.log(typeof hangmanPercent)
      console.log(hangmanPercent)

      this.setState({ lives: livesLeft });
      this.setState({ imgURL: hangmen[hangmanPercent] })
